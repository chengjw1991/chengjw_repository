...
function initTable(result) {
    ...
    var html = "<tr id='"+info.slh+"'>"+
        ...
        "<td class='czlc' style='text-align: center'><a href='javascript:;' onclick='selectCZLC("+info.slh+")' style='color: #0000FF;'>操作流程</a></td>"+
...
function selectCZLC(slh) {
    ...
    top.layer.open({
        ...
        type:2,
        area:['1100px','450px'],
        content:'/archivesAdmin/archivesPath',
        end:function () {
        }
    })
}
